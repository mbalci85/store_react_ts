...
export const ContactUsFormStyles = (isSmallScreen: boolean, isMediumScreen: boolean, theme: string): CSSProperties => ({
	display: 'flex',
	...
	backgroundColor: theme === 'Light' ? '#FFFF' : 'gray',
});
...
export const ContactUsInputStyles = (isSmallScreen: boolean, isMediumScreen: boolean) => ({
	...
	width: '100%',
	height: isSmallScreen ? '2.5rem' : isMediumScreen ? '3.5rem' : '4rem',
